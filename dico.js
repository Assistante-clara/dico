exports.action = function(data){
    ...
    var reg="/"+data.dico+"(.+)/i" ; var rgxp = eval(reg) ; var temp = ClaraIA.reco.match(rgxp) ; console.log(temp)
...
console.log("Clara doit chercher la définition de "+phrase)
    ...
    if(typeof file_content[phrase] != 'undefined' && file_content[phrase] != "") {
        ...
        request({ 'uri': url}, function(error, response, html) {
            ...
            if(definition == "") {
                ...
                ClaraIASpeech("Désolé, je n'ai pas réussi à trouver la définition du mot "+phrase);
            } else {
